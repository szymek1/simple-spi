...
##Pmod Header JA (XADC): used for SPI communication according to the diagram from README
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { cs }]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p   PIN 1		   
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { mosi }]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P      PIN 2       
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { miso }]; #IO_L24P_T3_AD15P_35 Sch=JA3_R_P     PIN 3       
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { sclk }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P      PIN 4       
...
##Pmod Header JE: used for LED outputs                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { led1 }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { led2 }]; #IO_L18N_T2_34 Sch=je[2]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { led3 }]; #IO_25_35 Sch=je[3]                          
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { led4 }]; #IO_L19P_T3_35 Sch=je[4]                     
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { led5 }]; #IO_L3N_T0_DQS_34 Sch=je[7]                  
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { led6 }]; #IO_L9N_T1_DQS_34 Sch=je[8]                  
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { led7 }]; #IO_L20P_T3_34 Sch=je[9]                     
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { led8 }]; #IO_L7N_T1_34 Sch=je[10]                    
